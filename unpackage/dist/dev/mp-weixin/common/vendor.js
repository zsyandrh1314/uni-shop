...
/***/ 11:
/*!*****************************************************************!*\
  !*** D:/Program Files/HBuilderProjects/uni-shop/store/store.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 13:
/*!****************************************************************!*\
  !*** D:/Program Files/HBuilderProjects/uni-shop/store/cart.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 创建购物车的 store 模块
var _default = {
  // 为当前模块开启命名空间
  namespaced: true,
  ...
  state: function state() {return {
      ...
      // 读取本地购物车的数据 JSON.parse转换为真正的数组 获取数据
  ...
  mutations: {
    addToCart: function addToCart(state, goods) {
      // 根据提交的商品的Id,查询购物车是否存在这件商品
      // 如果不存在，则 findResult 为 undefined 否则，为查找的商品信息对象
      // find() 会循环数组中的每一项  x来表示每一个信息对象x.goods_id等于外界传过来的goods——id
    ...
    saveToStorage: function saveToStorage(state) {
      // JSON.stringify() 先将数组转换为字符串存储到本地
...
var _default = {
  ...
  watch: {
    ...
    total: function total() {
      // 监听 methods 中 setBadge 方法， 重新为 tabBar 的数字徽章赋值
      this.setBadge();
    } },
...
/***/ 4:
/*!*************************************************************!*\
  !*** D:/Program Files/HBuilderProjects/uni-shop/pages.json ***!
  \*************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
